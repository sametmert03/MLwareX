...
parser.add_argument('--model_path', type=str, default='E:\\Studies\\TEZ\\MalConv-keras-master\\MalConv-keras-master\\saved\\malconv.h5')
parser.add_argument('--result_path', type=str, default='E:\\Studies\\TEZ\\MalConv-keras-master\\MalConv-keras-master\\src\\samp\\result.csv')
